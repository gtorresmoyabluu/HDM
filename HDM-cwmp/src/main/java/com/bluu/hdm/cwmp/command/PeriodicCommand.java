...
import com.bluu.hdm.cwmp.object.Layer2InterfaceObject;
import com.bluu.hdm.cwmp.object.PerformanceJAXBWrapper;
import com.bluu.hdm.cwmp.object.PerformanceObject;
import com.bluu.hdm.cwmp.object.SimpleObject;
import com.bluu.hdm.cwmp.object.WanServiceObject;
import com.bluu.hdm.cwmp.tree.DataFileUtils;
import com.bluu.hdm.cwmp.tree.Root;
import com.bluu.hdm.cwmp.tree.TreeUtils;
...
//        pf.setTime(new Date());
    ...
    public ArrayList<Layer2InterfaceObject> getATMInterface(Root tempRoot) throws Exception {
        ArrayList<Layer2InterfaceObject> returnValue = new ArrayList<>();
        //get data from file
