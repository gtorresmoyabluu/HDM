...
import com.bluu.hdm.cwmp.message.DeleteObjectResponse;
import com.bluu.hdm.cwmp.message.Download;
import com.bluu.hdm.cwmp.message.DownloadResponse;
import com.bluu.hdm.cwmp.message.FactoryReset;
import com.bluu.hdm.cwmp.message.Fault;
import com.bluu.hdm.cwmp.message.Fault.SetParameterValueFault;
import com.bluu.hdm.cwmp.message.GetOptions;
import com.bluu.hdm.cwmp.message.GetOptionsResponse;
import com.bluu.hdm.cwmp.message.GetOptionsResponse.OptionStruct;
import com.bluu.hdm.cwmp.message.GetParameterAttributes;
import com.bluu.hdm.cwmp.message.GetParameterAttributesResponse;
...
import com.bluu.hdm.cwmp.message.ScheduleInform;
import com.bluu.hdm.cwmp.message.SetParameterAttributes;
...
import com.bluu.hdm.cwmp.message.Upload;
import com.bluu.hdm.cwmp.message.UploadResponse;
import com.bluu.hdm.cwmp.message.X_00000C_ShowStatus;
import com.bluu.hdm.cwmp.message.X_00000C_ShowStatusResponse;
import com.bluu.hdm.cwmp.message.X_JUNGO_COM_RGCommand;
import com.bluu.hdm.cwmp.message.X_JUNGO_COM_RGCommandResponse;
...
//            throw new RuntimeException(fault.getFaultString () +fault.getFaultStringCwmp ());
    ...
    private Scriptable ExportInform(Context cx, Scriptable top) {
        ...
        int i = 0;
        for (Map.Entry<String, String> ev : lastInform.getEvents()) {
...
//            int Notification = ((Double) o.get("Notification", o)).intValue();
     ...
     */
    private static Scriptable toNativeArray(Context cx, Scriptable scriptable, Set<Map.Entry<String, String>> s, String n, String k) {
...
//        msg_in.FileSize = Long.parseLong((String)args[5]);
    ...
    public static Scriptable jsFunction_X_00000C_ShowStatus(Context cx, Scriptable thisObj, Object[] args, Function funObj) {
        ...
        Iterator<Map.Entry<String, String>> i = msg_out.response.entrySet().iterator();
        int ix = 0;
        while (i.hasNext()) {
