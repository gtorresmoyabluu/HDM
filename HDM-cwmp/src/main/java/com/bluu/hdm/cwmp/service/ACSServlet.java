...
import com.bluu.hdm.cwmp.executor.STBNMSWorker;
import com.bluu.hdm.cwmp.http.ACSAuthenticator;
import com.bluu.hdm.cwmp.http.HttpAuthentication;
...
import com.bluu.hdm.cwmp.message.InformResponse;
...
import com.bluu.hdm.cwmp.message.TransferCompleteResponse;
import com.bluu.hdm.cwmp.model.ModemInterfaceGroups;
...
import static com.bluu.hdm.cwmp.tree.DataFileUtils.getIPfromConnectionRequest;
import com.bluu.hdm.cwmp.utils.BeanUtils;
import com.bluu.hdm.cwmp.utils.ConfigUtils;
import com.bluu.hdm.cwmp.utils.Jms;
    ...
    private void sendAsJson(HttpServletResponse response, String obj) throws IOException {
        try {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                String res = _gson.toJson(request);
                out.print(res);
                out.print("\n");
                out.flush();
            }
        } catch (SOAPException ex) {
            java.util.logging.Logger.getLogger(ACSServlet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    }
...
//                    }
            ...
            logger.info("SENT_ Message:\n" + out.toString());

            sout = out.toString().replace('\'', '"');
            //sout = sout.replace(' ', '\n');
            // Write output to stream
            //OutputStream outstrm = response.getOutputStream();
            // out.writeTo(outstrm);
            // outstrm.flush();
            //response.getOutputStream().write(sout.getBytes());
        ...
        sendAsJson(response, out.toString());
        return;
    }
