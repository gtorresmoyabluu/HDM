...
import com.bluu.hdm.rest.repository.inventory.ModelRepository;
...
public class ModelDAOImpl implements IModelDAO {
    ...
    @Override
    public List<ModelEntity> findAllByOrderByidManufacturerAsc() {
        return modelRepository.findAllByOrderByManufacturerAsc();
    }

    @Override
    public Optional<ModelEntity> findByManufacturerIdAndName(Long id, String name) {
        return modelRepository.findByManufacturerIdAndName(id, name);
    }
}
