...
import com.bluu.hdm.rest.dao.interfaces.administration.ICategoryDAO;
import com.bluu.hdm.rest.entity.CategoryEntity;
import com.bluu.hdm.rest.service.generic.IService;
import com.bluu.hdm.rest.vo.administration.CategoryVO;
...
public class CategoryService implements IService<CategoryVO, Long> {
    ...
    @Override
    public ResponseEntity<CategoryVO> update(@RequestBody CategoryVO oRequest) {
