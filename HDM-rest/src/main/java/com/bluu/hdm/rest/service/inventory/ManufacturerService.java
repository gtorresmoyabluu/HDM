...
public class ManufacturerService {
    ...
    public ResponseEntity<Void> save(@RequestBody ManufacturerVO mRequest, UriComponentsBuilder ucBuilder) {
        ...
        if (mRequest.getModelEntitySet() != null) {
    ...
    public ResponseEntity<ManufacturerVO> update(@RequestBody ManufacturerVO mRequest) {
        System.out.println("Updating User " + mRequest.getId());
        if (!mService.isExist(mRequest.getId())) {
            logger.error("Manufacturer with id " + mRequest.getId() + " not found");
