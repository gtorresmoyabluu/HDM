...
public abstract class CryptoUtils {
    ...
    /**
     * Longitud del <code>salt</code> para el algoritmo hash. Igual al tamaño del resultado del algoritmo.
     */
     ...
     * <p>
     * Este método genera un valor de <code>salt</code> aleatorio y lo utiliza para calcular repetitivamente tantas operaciones de <code>hash</code> como indique {@link #HASH_ITERATIONS}.
     * <p>
     * El objeto {@link PasswordHash} devuelto contiene el <code>hash</code> calculado y el <code>salt</code> generado.
     *
    ...
    /**
     * Comprueba si el <code>hash</code> calculado para el valor y el <code>salt</code> indicados es igual al <code>hash</code> correcto indicado.
     * <p>
     ...
     * @param salt el <code>salt</code> a utilizar para la generación del <code>hash</code> de <code>value</code>. Debe ser el mismo que el utilizado para calcular <code>hash</code>.
     * @return <code>true</code> si el <code>hash</code> de <code>value</code> usando <code>salt</code> es igual a <code>correctHash</code>.
     */
