...
public class LicenseVO {
    ...
    public LicenseVO(String code, Long cpeThreshold) {
        this.code = code;
     ...
     * <p>
     * - Se produce un error de cualquier tipo al parsear la licencia.<br>
     * - Se ha pasado la fecha de expiración.<br>
     * - La IP de la licencia no corresponde con la actual.<br>
     * <p>
     * La licencia no se bloqueará y dará los siguientes mensajes si:
     * <p>
     * - Mensajes de error:.<br>- Se ha superado el límite de CPEs
     * <p>
     * - Mensajes de warning:.<br>- Queda menos de un 10% para alcanzar el límite máximo de CPE.<br>
     * - La licencia está cercana a expirar (faltan menos de 30 días)
     *
     * @param cpeCount
     */
